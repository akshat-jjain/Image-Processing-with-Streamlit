...
def welcome():
    ...
    # st.image('hackershrine-images.jpg',use_column_width=True)
...
def photo():
    ...
    if st.button('See Original Image of Tom'):
        ...
        original = Image.open('tom-images.jpg')
        st.image(original, use_column_width=True)
        
    image = cv2.imread('tom-images.jpg')
...
def video():
    ...
    video_file = open('typing-videos.mp4', 'rb')
...
def face_detection():
    ...
    if st.button('See Original Image'):
        ...
        original = Image.open('friends-images.jpeg')
        st.image(original, use_column_width=True)
    
    
    image2 = cv2.imread("friends-images.jpeg")
    ...
    cv2.imwrite("faces-images.jpg", image2)
...
def feature_detection():
    ...
    st.write("SIFT")
    image = load_image("tom1-images.jpg")
    ...
    st.write("FAST")
    image_fast = load_image("tom1-images.jpg")
...
def object_detection():
    ...
    img = load_image("clock-images.jpg")
    ...
    image = load_image("eyes-images.jpg")
